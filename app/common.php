...
/* 理论成绩处理 */
function handle_major_score($arr)
{
	$total = 0;
...
function major_score_desc($major_score_key,$major_score_arr)
{
	$html = '';
...
function handle_major_score_arr($major_score_key,$major_score_arr)
{
	$arr = array();
	foreach ($major_score_key as $key => $value) {
