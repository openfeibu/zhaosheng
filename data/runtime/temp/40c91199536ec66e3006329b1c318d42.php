<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:79:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\school\recruit_major_list.html";i:1491324276;s:65:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\base.html";i:1489327654;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\header.html";i:1491414163;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\left_nav.html";i:1489327654;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\head_nav.html";i:1491414239;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\footer.html";i:1491413996;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="col-xs-4 col-sm-2 margintop5">
				<a href="<?php echo url('admin/School/recruit_major_add'); ?>">
			...
			<div class="col-xs-10 col-sm-5 margintop5">
				<form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('admin/School/recruit_major_list'); ?>">
			...
			<div class="col-xs-4 col-sm-5 margintop5">
				<div class="input-group-btn">
					<a href="<?php echo url('admin/School/major_list'); ?>">
					...
					<form id="leftnav" name="leftnav" method="post" action="" >
						...
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<?php if(is_array($major_list) || $major_list instanceof \think\Collection || $major_list instanceof \think\Paginator): if( count($major_list)==0 ) : echo "" ;else: foreach($major_list as $key=>$v): ?>
								<tr>
									<td height="28" ><?php echo $v['recruit_major_name']; ?></td>
                                    <td><?php echo $v['number']; ?></td>
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a class="green" href="<?php echo url('admin/School/recruit_major_edit',array('recruit_major_id'=>$v['recruit_major_id'])); ?>" title="修改">
												<i class="ace-icon fa fa-pencil bigger-130"></i>																</a>
												<a class="red confirm-rst-url-btn" data-info="你确定要删除吗？" href="<?php echo url('admin/School/recruit_major_del',array('recruit_major_id'=>$v['recruit_major_id'])); ?>" title="删除">
