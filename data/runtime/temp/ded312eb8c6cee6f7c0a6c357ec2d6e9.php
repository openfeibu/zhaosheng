<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\score\score_add.html";i:1491301056;s:65:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\base.html";i:1489327654;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\header.html";i:1491414163;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\left_nav.html";i:1489327654;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\head_nav.html";i:1491414239;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\footer.html";i:1491413996;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-header">
		<h1>
			...
			<small>
				...
				录入基础理论成绩--<?php echo $member_list_edit['member_list_nickname']; ?>
			</small>
		</h1>
	</div>
	<div class="row">
	    <div class="col-xs-12">
                <form class="form-horizontal" name="score_edit" method="post" action="<?php echo url('admin/Score/score_runadd'); ?>">
			<input type="hidden" name="member_list_id" value="<?php echo $member_list_edit['member_list_id']; ?>"/>
			<?php if(is_array($major_score) || $major_score instanceof \think\Collection || $major_score instanceof \think\Paginator): if( count($major_score)==0 ) : echo "" ;else: foreach($major_score as $k=>$v): ?>
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <?php echo $v; ?>: </label>
				<div class="col-sm-10">
					<input type="text" name="score[]" value="<?php if(isset($major_score_val)): ?><?php echo $major_score_val[$k]; endif; ?>" class="col-xs-10 col-sm-4" required/>
				</div>
			</div>
