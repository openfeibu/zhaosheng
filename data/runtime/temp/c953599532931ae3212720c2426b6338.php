<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:70:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\admin\admin_edit.html";i:1491057082;s:65:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\base.html";i:1489327654;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\header.html";i:1491414163;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\left_nav.html";i:1489327654;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\head_nav.html";i:1491414239;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\footer.html";i:1491413996;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal adminform" name="admin_list_edit" method="post" action="<?php echo url('admin/Admin/admin_runedit'); ?>">
					...
					<div class="space-4"></div>-->
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 所属中职（添加中职管理员必选）: </label>
						<div class="col-sm-10">
							<select name="school_id"  class="col-sm-5" id="school">
								...
								<?php if(is_array($school_list) || $school_list instanceof \think\Collection || $school_list instanceof \think\Paginator): if( count($school_list)==0 ) : echo "" ;else: foreach($school_list as $key=>$v): ?>
									<option value="<?php echo $v['school_id']; ?>" <?php if($v['school_id'] == $admin_list['school_id']): ?>selected<?php endif; ?> ><?php echo $v['school_name']; ?></option>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 所属中职专业（添加中职管理员必选）: </label>
						<div class="col-sm-10">
							<select name="major_id"  class="col-sm-5" id="major">
								<?php if(is_array($major_list) || $major_list instanceof \think\Collection || $major_list instanceof \think\Paginator): if( count($major_list)==0 ) : echo "" ;else: foreach($major_list as $key=>$v): ?>
									<option value="<?php echo $v['major_id']; ?>" <?php if($v['major_id'] == $admin_list['major_id']): ?>selected<?php endif; ?> ><?php echo $v['major_name']; ?></option>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>
					</div>
