<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:72:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\member\member_edit.html";i:1491408448;s:65:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\base.html";i:1489327654;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\header.html";i:1491414163;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\left_nav.html";i:1489327654;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\head_nav.html";i:1491414239;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\footer.html";i:1491413996;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<ul class="nav nav-list">
				...
				<li>
					<a href="<?php echo url('admin/Index/index'); ?>">
						<o class="font12">欢迎使用自主招生后台系统管理</o>
					</a>
					<b class="arrow"></b>
				</li>
				<?php endif; ?>
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal memberform" name="member_list_edit" method="post" action="<?php echo url('admin/Member/member_runedit'); ?>">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 是否激活（请审核下方用户上传资料）： </label>
						<div class="col-sm-10" style="padding-top:5px;">
		...
		<div class="row">
			...
			<table width="656px" class="k-w-table line_table">
				<tbody><tr class="line-table-height">
					...
					<td class="k-s-content low_width_2 content"><input type="text" name="name" value="<?php echo $info['name']; ?>" disabled/></td>
					...
					<td class="k-s-content low_width_6 content"><input type="text" name="GexamineeNumber" value="<?php echo $info['GexamineeNumber']; ?>" disabled/></td>
				...
				<tr class="line-table-height">
					...
					<td class="k-s-content content"><input type="text" name="nation" value="<?php echo $info['nation']; ?>" disabled/></td>
					<td class="k-s-content title">政治面貌</td>
					<td class="k-s-content content"><input type="text" name="politicalOutlook" value="<?php echo $info['politicalOutlook']; ?>" disabled/></td>
				</tr>
				<tr class="line-table-height">
					 <td class="k-s-content title">证件类型</td>
					<td class="k-s-content content">
						<input type="text" name="documentType" value="<?php echo $info['documentType']; ?>" disabled/>
					</td>
					<td class="k-s-content low_width_1 title">身份证号</td>
					<td class="k-s-content content" colspan="3"><input type="text" name="cardId" value="<?php echo $info['cardId']; ?>" disabled/></td>

				</tr>
				<tr class="line-table-height">
					<td class="k-s-content content title">户籍地</td>
					<td class="k-s-content content"><input type="text" name="domicile" value="<?php echo $info['domicile']; ?>" disabled/></td>
					...
					<td class="k-s-content content">
						<input type="text" name="school" value="<?php echo $info['school']; ?>" disabled disabled/>
					</td>
				...
				<tr class="line-table-height">
					...
					<td class="k-s-content content">
					<input type="text" name="ZexamineeNumber" value="<?php echo $info['ZexamineeNumber']; ?>" disabled/>
					</td>
					 <td class="k-s-content title" colspan="1">考生类别</td>
					<td class="k-s-content content">
						<input type="text" name="candidateCategory" value="<?php echo $info['candidateCategory']; ?>" disabled/>
					</td>
				</tr>
				<!-- 第6行 -->
				<tr class="line-table-height">
					...
					<td class="k-s-content content" colspan="3">
						<input type="text" name="address" value="<?php echo $info['address']; ?>" disabled/>
					</td>
					<td class="k-s-content title">邮编</td>
					<td class="k-s-content content" colspan="1">
						<input type="text" name="zipCode" value="<?php echo $info['zipCode']; ?>" disabled/>
					</td>
				</tr>
				<tr class="line-table-height">
					<td class="k-s-content low_width_1 title"  colspan="2">收件人</td>
					<td class="k-s-content content" colspan="2">
						<input type="text" name="addressee" value="<?php echo $info['addressee']; ?>" disabled/>
					</td>
					<td class="k-s-content title" colspan="1">联系电话</td>
					<td class="k-s-content content" colspan="2">
						<input type="text" name="tell" value="<?php echo $info['tell']; ?>" disabled/>
					</td>
				</tr>
				<tr class="line-table-height">
				...
				<tr class="line-table-height">
					<td class="k-s-content title" colspan="2"><input type="text" name="certificateName_0" value="<?php echo $info['certificate']['0']['certificateName']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="1"><input type="text" name="certificateLevel_0" value="<?php echo $info['certificate']['0']['certificateLevel']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="certificateCompany_0" value="<?php echo $info['certificate']['0']['certificateCompany']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="certificateDate_0" value="<?php echo $info['certificate']['0']['certificateDate']; ?>" disabled/></td>

				</tr>
				<tr class="line-table-height">
					<td class="k-s-content title" colspan="2"><input type="text" name="certificateName_1" value="<?php echo $info['certificate']['1']['certificateName']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="1"><input type="text" name="certificateLevel_1" value="<?php echo $info['certificate']['1']['certificateLevel']; ?>"value="<?php echo $info['certificate']['0']['certificateName']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="certificateCompany_1" value="<?php echo $info['certificate']['1']['certificateCompany']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="certificateDate_1" value="<?php echo $info['certificate']['1']['certificateDate']; ?>" disabled/></td>

				</tr>
				<tr class="line-table-height">
					<td class="k-s-content title" colspan="2"><input type="text" name="certificateName_2" value="<?php echo $info['certificate']['2']['certificateName']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="1"><input type="text" name="certificateLevel_2" value="<?php echo $info['certificate']['2']['certificateLevel']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="certificateCompany_2" value="<?php echo $info['certificate']['2']['certificateCompany']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="certificateDate_2" value="<?php echo $info['certificate']['2']['certificateDate']; ?>" disabled/></td>
				</tr>
				...
				<tr class="line-table-height">
					<td class="k-s-content title" colspan="2"><input type="text" name="resumeBeforeDate_0" value="<?php echo $info['resume']['0']['resumeBeforeDate']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="resumeAfterDate_0" value="<?php echo $info['resume']['0']['resumeAfterDate']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="resumeWork_0" value="<?php echo $info['resume']['0']['resumeWork']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="1"><input type="text" name="resumePost_0" value="<?php echo $info['resume']['0']['resumePost']; ?>" disabled/></td>

				</tr>
				<tr class="line-table-height">
					 <td class="k-s-content title" colspan="2"><input type="text" name="resumeBeforeDate_1" value="<?php echo $info['resume']['1']['resumeBeforeDate']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="resumeAfterDate_1" value="<?php echo $info['resume']['1']['resumeAfterDate']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="resumeWork_1" value="<?php echo $info['resume']['1']['resumeWork']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="1"><input type="text" name="resumePost_1" value="<?php echo $info['resume']['1']['resumePost']; ?>" disabled/></td>

				</tr>
				<tr class="line-table-height">
					  <td class="k-s-content title" colspan="2"><input type="text" name="resumeBeforeDate_2" value="<?php echo $info['resume']['2']['resumeBeforeDate']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="resumeAfterDate_2" value="<?php echo $info['resume']['2']['resumeAfterDate']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="resumeWork_2" value="<?php echo $info['resume']['2']['resumeWork']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="1"><input type="text" name="resumePost_2" value="<?php echo $info['resume']['2']['resumePost']; ?>" disabled/></td>
				...
				<tr class="line-table-height">
				 ...
				 <tr class="line-table-height">
					<td class="k-s-content title" colspan="2"><input type="text" name="prizeDate_0"  value="<?php echo $info['prize']['0']['prizeDate']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="prizeName_0"  value="<?php echo $info['prize']['0']['prizeName']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="3"><input type="text" name="prizeCompany_0"  value="<?php echo $info['prize']['0']['prizeCompany']; ?>" disabled/></td>

				</tr>
				 <tr class="line-table-height">
					<td class="k-s-content title" colspan="2"><input type="text" name="prizeDate_1"  value="<?php echo $info['prize']['1']['prizeDate']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="2"><input type="text" name="prizeName_1"  value="<?php echo $info['prize']['1']['prizeName']; ?>" disabled/></td>
					<td class="k-s-content title" colspan="3"><input type="text" name="prizeCompany_1"  value="<?php echo $info['prize']['1']['prizeCompany']; ?>" disabled/></td>
				</tr>
				 <tr class="line-table-height">
					<td class="k-s-content title" colspan="1">处分情况</td>
					<td class="k-s-content title" colspan="6">
						<input type="text" name="punishment"  disabled/>
					</td>
				</tr>
				<tr class="line-table-height">
				...
				<tr class="line-table-height">
				 ...
				 <tr class="line-table-height">
				   <td class="k-s-content title" colspan="1">
						<input type="text" name="familyPunishment_0" value="<?php echo $info['family']['0']['familyPunishment']; ?>" disabled/>
					</td>
					<td class="k-s-content title" colspan="1">
						<input type="text" name="familyName_0" value="<?php echo $info['family']['0']['familyName']; ?>" disabled/>
					</td>
					<td class="k-s-content title" colspan="3">
						<input type="text" name="familyWork_0" value="<?php echo $info['family']['0']['familyWork']; ?>" disabled/>
					</td>
					<td class="k-s-content title" colspan="2">
						<input type="text" name="familyTell_0" value="<?php echo $info['family']['0']['familyTell']; ?>" disabled/>
					</td>
				</tr>
				<tr class="line-table-height">
					<td class="k-s-content title" colspan="1">
						<input type="text" name="familyPunishment_1" value="<?php echo $info['family']['1']['familyPunishment']; ?>"  disabled/>
					</td>
					<td class="k-s-content title" colspan="1">
						<input type="text" name="familyName_1" value="<?php echo $info['family']['1']['familyName']; ?>" disabled/>
					</td>
					<td class="k-s-content title" colspan="3">
						<input type="text" name="familyWork_1" value="<?php echo $info['family']['1']['familyWork']; ?>" disabled/>
					</td>
					<td class="k-s-content title" colspan="2">
						<input type="text" name="familyTell_1" value="<?php echo $info['family']['1']['familyTell']; ?>" disabled/>
					</td>
				</tr>
				<tr class="line-table-height">
					<td class="k-s-content title" colspan="1">
						<input type="text" name="familyPunishment_2" value="<?php echo $info['family']['2']['familyPunishment']; ?>" disabled/>
					</td>
					<td class="k-s-content title" colspan="1">
						<input type="text" name="familyName_2" value="<?php echo $info['family']['2']['familyName']; ?>" disabled/>
					</td>
					<td class="k-s-content title" colspan="3">
						<input type="text" name="familyWork_2" value="<?php echo $info['family']['2']['familyWork']; ?>" disabled/>
					</td>
					<td class="k-s-content title" colspan="2">
						<input type="text" name="familyTell_2" value="<?php echo $info['family']['2']['familyTell']; ?>" disabled/>
					</td>
				</tr>
	...
	<div class="footer-inner">
		<div class="footer-content">
			<span class="bigger-120">
				<span class="blue bolder">招生</span>
