<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\score\score_all.html";i:1491328422;s:65:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\base.html";i:1489327654;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\header.html";i:1491414163;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\left_nav.html";i:1489327654;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\head_nav.html";i:1491414239;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\footer.html";i:1491413996;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
        ...
        <div class="row maintop">
			...
			<form name="admin_list_sea" class="form-search" id="list-filter" method="post" action="<?php echo url('admin/Score/score_all'); ?>">
				<div class="col-xs-12 col-sm-4  margintop5">

					<select name="activetype_check" class="ajax_change">
						<option value="">按激活状态</option>
                        <option value="2" <?php if($activetype_check == '0'): ?>selected="selected"<?php endif; ?> >不通过</option>
						<option value="1" <?php if($activetype_check == '1'): ?>selected="selected"<?php endif; ?>>已通过</option>
						<option value="0" <?php if($activetype_check == '0'): ?>selected="selected"<?php endif; ?> >未审核</option>
					</select>
				</div>
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form id="score_form" name="leftnav" method="post" action="<?php echo url('admin/Score/score_active'); ?>" >
						...
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
                            ...
                            <tr>
                                <td class="hidden-xs" height="28" >
									<label class="pos-rel">
										<input name="n_id[]" id="navid" class="ace" type="checkbox" value="<?php echo $v['major_score_id']; ?>">
										<span class="lbl"></span>
									</label><?php echo $v['major_score_id']; ?>
								</td>
                                ...
                                <td>
									<?php if(is_array($v['major_score_key']) || $v['major_score_key'] instanceof \think\Collection || $v['major_score_key'] instanceof \think\Paginator): if( count($v['major_score_key'])==0 ) : echo "" ;else: foreach($v['major_score_key'] as $key=>$val): ?>
										<span style="margin-left:5px;"><?php echo $val; ?> : <?php echo $v['major_score_list'][$key]; ?></span>
                            ...
                            <tr>
                                <td height="50" align="center">
                                    ...
                                    <button id="btnsubmit" class="btn btn-white btn-yellow btn-sm hidden-xs btn-unactive">不通过</button>
                                </td>
