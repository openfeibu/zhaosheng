<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/home/view/default/\index.html";i:1490559166;s:72:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/home/view/default/public\head.html";i:1490541958;s:76:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/home/view/default/public\function.html";i:1489327654;s:74:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/home/view/default/public\config.html";i:1489327654;s:74:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/home/view/default/public\footer.html";i:1490885736;}*/ ?>
<?php 
/*这里只是一个模板函数库演示*/
function helloworld(){
	echo "hello YFCMF!";
...
<body>
    ...
    <div class="main w1000">
        ...
        <div class="login">
            <!-- 登录成功 -->
            <?php if(isset($user) && isset($user['member_list_id'])): ?>
            <div class="success">
                <p><span><?php echo $user['member_list_nickname']; ?> 同学</span>登录成功</p>
                <a href="<?php echo url('home/center/index'); ?>">个人中心</a>
            </div>
            <?php else: ?>
            <div class="login-title">自主招生报名登录</div>
            <form action="<?php echo url('home/Login/runlogin'); ?>" method="post">
                ...
                <div class="input-item">
                     <label for="">验证码：</label>
                     <input type="text" name="verify" style="width:70px"/>
                     <div class="code">
                       <img src="<?php echo url('home/Login/verify'); ?>"  onClick="this.src='<?php echo url('home/Login/verify'); ?>'+'?'+Math.random()" >
                     </div>
        ...
        <div class="fb-portlet">
            <div class="fb-portlet-title">
                <span>自主招生新闻</span>
                <a href="<?php echo url('home/Listn/index',array('id'=>17)); ?>" class="fb-portlet-more fb-transition">更多</a>
            </div>
            <ul>
              <?php $news=get_news("cid:17;field:news_content,news_title,n_id,news_columnid,news_time;limit:7;order:news_time desc",false,10,"null","");if(is_array($news) || $news instanceof \think\Collection || $news instanceof \think\Paginator): if( count($news)==0 ) : echo "" ;else: foreach($news as $k=>$vo): ?>
        ...
        <div class="portlet">
            ...
            <div class="fb-portlet-url">
                ...
                <div class="input-item">
                    ...
                    <select onchange="mbar(this)" name="select" style="width:145px;height:27px" >
        ...
        <div class="fb-portlet">
            <div class="fb-portlet-title">
                <span>招生政策</span>
                <a href="<?php echo url('home/Listn/index',array('id'=>18)); ?>" class="fb-portlet-more fb-transition">更多</a>
            </div>
            <ul>
                <?php $policys=get_news("cid:18;field:news_content,news_title,n_id,news_columnid,news_time;limit:7;order:news_time desc",false,10,"null","");if(is_array($policys) || $policys instanceof \think\Collection || $policys instanceof \think\Paginator): if( count($policys)==0 ) : echo "" ;else: foreach($policys as $k=>$vo): ?>
                <li><a href="<?php echo url('home/News/index',array('id'=>$vo['n_id'])); ?>"><p><?php echo $vo['news_title']; ?></p><span><?php echo date("Y-m-d",$vo['news_time']); ?></span></a></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="fb-portlet" style="margin-left: 15px;">
            <div class="fb-portlet-title">
                <span>通知公告</span>
                <a href="<?php echo url('home/Listn/index',array('id'=>16)); ?>" class="fb-portlet-more fb-transition">更多</a>
            </div>
            <ul>
              <?php $notics=get_news("cid:16;field:news_content,news_title,n_id,news_columnid,news_time;limit:7;order:news_time desc",false,10,"null","");if(is_array($notics) || $notics instanceof \think\Collection || $notics instanceof \think\Paginator): if( count($notics)==0 ) : echo "" ;else: foreach($notics as $k=>$vo): ?>
              <li><a href="<?php echo url('home/News/index',array('id'=>$vo['n_id'])); ?>"><p><?php echo $vo['news_title']; ?></p><span><?php echo date("Y-m-d",$vo['news_time']); ?></span></a></li>
              <?php endforeach; endif; else: echo "" ;endif; ?>
...
<script type="text/javascript">
  $(".login form").on("submit",function(){
    ...
    $.post("<?php echo url('home/Login/runlogin'); ?>",form,function(data){
        if(data.code == 1){
          // success
          window.location.href = '<?php echo url('home/center/index'); ?>';
        }else if (data.code == 0){
          alert(data.msg);
        }
