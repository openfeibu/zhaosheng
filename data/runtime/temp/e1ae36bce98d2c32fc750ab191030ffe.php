<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:72:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\school\school_list.html";i:1491324248;s:65:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\base.html";i:1489327654;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\header.html";i:1491414163;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\left_nav.html";i:1489327654;s:69:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\head_nav.html";i:1491414239;s:67:"D:\UPUPW_K2.1_64\htdocs\zhaosheng/app/admin\view\public\footer.html";i:1491413996;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="col-xs-4 col-sm-2 margintop5">
				<a href="<?php echo url('admin/School/school_add'); ?>">
			...
			<div class="col-xs-10 col-sm-5 margintop5">
				<form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('admin/School/school_list'); ?>">
					<div class="input-group">
										<span class="input-group-addon">
											<i class="ace-icon fa fa-check"></i>
										</span>
						<input type="text" name="search_name" class="form-control" value="<?php echo $search_name; ?>" placeholder="输入需查询的学校" />
			...
			<div class="col-xs-4 col-sm-5 margintop5">
				<div class="input-group-btn">
					<a href="<?php echo url('admin/School/school_list'); ?>">
					...
					<form id="leftnav" name="leftnav" method="post" action="" >
						...
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<?php if(is_array($school_list) || $school_list instanceof \think\Collection || $school_list instanceof \think\Paginator): if( count($school_list)==0 ) : echo "" ;else: foreach($school_list as $key=>$v): ?>
								<tr>
									<td height="28" ><a href="<?php echo url('admin/School/major_list',array('school_id'=>$v['school_id'])); ?>"><?php echo $v['school_name']; ?></a></td>
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a class="blue" href="<?php echo url('admin/School/major_add',array('id'=>$v['school_id'])); ?>" data-toggle="tooltip" title="" data-original-title="添加子类">
												<i class="ace-icon fa fa-plus-circle bigger-130"></i>
											</a>
											<a class="green" href="<?php echo url('admin/School/school_edit',array('school_id'=>$v['school_id'])); ?>" title="修改">
												<i class="ace-icon fa fa-pencil bigger-130"></i>																</a>
												<a class="red confirm-rst-url-btn" data-info="你确定要删除吗？" href="<?php echo url('admin/School/school_del',array('school_id'=>$v['school_id'])); ?>" title="删除">
							...
							<tr>
								<td height="50" colspan="2" align="left"><?php echo $page; ?></td>
							</tr>
						</table>
					</form>
				</div>
